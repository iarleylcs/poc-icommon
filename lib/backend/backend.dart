...
import 'schema/rodizios_record.dart';
...
export 'schema/rodizios_record.dart';
...
/// Functions to query RodiziosRecords (as a Stream and as a Future).
Future<int> queryRodiziosRecordCount({
  Query Function(Query)? queryBuilder,
  int limit = -1,
}) =>
    queryCollectionCount(
      RodiziosRecord.collection,
      queryBuilder: queryBuilder,
      limit: limit,
    );

Stream<List<RodiziosRecord>> queryRodiziosRecord({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
    queryCollection(
      RodiziosRecord.collection,
      RodiziosRecord.fromSnapshot,
      queryBuilder: queryBuilder,
      limit: limit,
      singleRecord: singleRecord,
    );

Future<List<RodiziosRecord>> queryRodiziosRecordOnce({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
